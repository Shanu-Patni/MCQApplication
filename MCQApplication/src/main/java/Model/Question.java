...
public class Question {
	...
	public Question( String questionPaperTitle, String question, String option1, String option2, String option3,
			String option4,String difficultyLevel, String answerKey) {
		super();
